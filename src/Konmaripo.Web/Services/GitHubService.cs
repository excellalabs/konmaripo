...
namespace Konmaripo.Web.Services
{
    ...
    public class GitHubService : IGitHubService
    {
        ...
        public async Task<List<GitHubRepo>> GetRepositoriesForOrganizationAsync()
        {
            ...
            return repos.Select(x => new GitHubRepo(x.Id, x.Name, x.StargazersCount, x.Archived, x.ForksCount, x.OpenIssuesCount, x.CreatedAt, x.UpdatedAt, x.Description, x.Private, x.SubscribersCount)).ToList();
        }
    }
}
